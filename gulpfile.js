...
// ************************************************
// ## Custom Gulp tasks
// 1. SC5 Stylguide Generator
// 2. Theo Design Tokens
//
// ************************************************
// ////////////////////////////////////////////////
// var runSequence = require( 'run-sequence' );
...
var jsTasks = function(filename) {
  ...
  var jsDocSrc = [
    ...
    'assets/scripts/atomic.sg.js'
  ];

  var jsdocConfig = require('./assets/jsdoc-conf.json');
  var jsdocSrc = [
    'README--JSDOC.md',
    'assets/scripts/main.js'
  ];
  ...
  gulp.src(jsDocSrc)
    .pipe(docco())
    .pipe(gulp.dest('./dev-area/js-documentation/docco'));

  gulp.src(jsdocSrc, {read: false})
...
// ### Modernizr
// ////////////////////////////////////////////////
// `gulp modernizr` - Lints configuration JSON and project JS.
...
gulp.task('modernizr', function() {
  gulp.src( path.source + '/scripts/*.js')
    ...
    .pipe(gulp.dest(path.source + '/scripts/plugins/modernizr/'));
});
...
// ### Styleguide
// ////////////////////////////////////////////////
// `gulp styleguide` - Generate SC5 styleguide
var overviewPath = path.source + '/styles/README.md';
